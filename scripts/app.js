(function () {
    ...
    document.getElementById('butAddCity').addEventListener('click', function () {
		...
		//salva estacion seleccionada en localstorage
    ...
    var initialStationTimetable = {
        ...
        key: 'metros/1/nation/A',
        label: 'Nation, Direction La Défense',
    ...
    if (app.selectedTimetables) {
       console.log('Salvada la estacion '+app.selectedTimetables);
	 ...
	 /*****************************************************************************
	 *
	 * Verificiation of service worker
	 *
	 *****************************************************************************/
